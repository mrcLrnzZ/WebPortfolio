...
function Header({ darkMode, setDarkMode }) {
    return (
        <div className="flex text-black dark:text-white gap-7 mt-10 p-4 rounded-xl transition-colors duration-300">
            <div className="relative w-48 h-38 overflow-hidden rounded-lg shadow-lg">
                <img 
                    src={gillian1} 
                    alt="Gillian Light" 
                    className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ease-in-out ${darkMode ? 'opacity-0' : 'opacity-100'}`}
                />
                <img 
                    src={gillian} 
                    alt="Gillian Dark" 
                    className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ease-in-out ${darkMode ? 'opacity-100' : 'opacity-0'}`}
                />
            </div>
            ...
            <div className="w-full">
                ...
                <div className='flex flex-row gap-2 mt-2'>
                    <div className=''>
                        <button className="text-white text-sm cursor-pointer font-medium rounded-sm bg-gray-900 hover:bg-gray-700 text-black dark:text-black dark:bg-white dark:hover:bg-gray-100 px-2 py-2 flex items-center gap-2 shadow-md transition-all active:scale-95 hover:translate-y-[-2px]">
                    ...
                    <div>
                        <button className="text-black  text-sm cursor-pointer font-medium rounded-sm  dark:text-white  dark:hover:bg-gray-600/40 px-3 py-2 flex items-center gap-2 shadow-md transition-all active:scale-95 hover:translate-y-[-2px]">
                            <a href="https://github.com/mrcLrnzZ" target="_blank" rel="noopener noreferrer">
                    ...
                    <div>
                        <button className="text-black  text-sm cursor-pointer font-medium rounded-sm   dark:text-white  dark:hover:bg-gray-600/40 px-3 py-2 flex items-center gap-2 shadow-md transition-all active:scale-95 hover:translate-y-[-2px]">
                           <a href="https://www.linkedin.com/in/gillian-marc-lorenzo-797b45321/" target="_blank" rel="noopener noreferrer">
