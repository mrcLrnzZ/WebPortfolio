    ...
    return (
        <div className="flex flex-col sm:flex-row text-black dark:text-white gap-7 mt-10 p-4 rounded-xl transition-colors duration-300">
            ...
            <div className="w-full text-center sm:text-left">
                ...
                <div className='mt-2 rounded-lg flex items-center justify-center sm:justify-start gap-2 w-full sm:w-fit'>
                ...
                <div className='flex flex-col sm:flex-row items-center gap-3 mt-6 w-full'>
                    ...
                    <div className='flex gap-3 w-full sm:w-auto mt-2 sm:mt-0'>
                        <a href="https://github.com/mrcLrnzZ" target="_blank" rel="noopener noreferrer" className="flex-1 sm:flex-none">
                            <button className="w-full text-black text-sm cursor-pointer font-medium rounded-sm dark:text-white dark:bg-gray-800/20 dark:hover:bg-gray-700/30 px-5 py-2.5 flex items-center justify-center gap-2 shadow-md transition-all active:scale-95 hover:translate-y-[-2px]">
                        ...
                        <a href="https://www.linkedin.com/in/gillian-marc-lorenzo-797b45321/" target="_blank" rel="noopener noreferrer" className="flex-1 sm:flex-none">
                            <button className="w-full text-black text-sm cursor-pointer font-medium rounded-sm dark:text-white dark:bg-gray-800/20 dark:hover:bg-gray-700/30 px-5 py-2.5 flex items-center justify-center gap-2 shadow-md transition-all active:scale-95 hover:translate-y-[-2px]">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
